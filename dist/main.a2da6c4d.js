...
var x = localStorage.getItem('x'); //尝试读取当前网站下的x

var xObject = JSON.parse(x); //把字符串重新变回对象
...
var render = function render() {
  ...
  hashMao.forEach(function (node, index) {
...
window.onbeforeunload = function () {
  var string = JSON.stringify(hashMao); //把对象变成字符串
